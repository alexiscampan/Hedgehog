defmodule Hedgehog.Exchange.BinanceMock do
  ...
  alias Binance.Structs.Order
  alias Binance.Structs.OrderResponse
  ...
  def get_exchange_info() do
    case @use_cached_exchange_info do
      ...
      _ -> Binance.Market.get_exchange_info()
    end
  end
  ...
  def convert_order_to_order_response(%Binance.Structs.Order{} = order) do
    %{
      struct(
  ...
  def handle_cast(
        {:add_order, %Binance.Structs.Order{symbol: symbol} = order},
        %State{
  ...
  defp add_order(
         %Binance.Structs.Order{symbol: symbol} = order,
         order_books
       ) do
    order_book =
      Map.get(
  ...
  defp convert_order_to_event(%Binance.Structs.Order{} = order, time) do
    %TradeEvent{
